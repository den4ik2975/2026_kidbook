...
<!-- Картинка: схема компонентов браузера — блоки: Интерфейс, Движок браузера, 
1.png
Движок рендеринга, Сетевой модуль, JavaScript-движок, Хранилище -->
...
<!-- Картинка: пайплайн рендеринга — стрелки: HTML → DOM → Render Tree → Layout → 
2.png
Paint → Composite -->
