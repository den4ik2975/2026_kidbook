...
<!-- Картинка: схема всего пути от браузера до сервера и обратно — стрелки: Браузер
5.png
 → DNS → Сервер → Браузер, с подписями каждого шага -->
...
<!-- Картинка: разобранный URL с подписями каждой части — https:// | ru.wikipedia.
6.png
org | /wiki/Кот -->
