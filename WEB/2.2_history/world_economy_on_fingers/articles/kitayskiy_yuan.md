...
Из-за этого юань сравнивают с [долларом США](./dollar_ssha.md) и [евро](./evro.md). Но сравнение не означает, что эти валюты уже равны по влиянию. Пока доллар и евро играют в мировой системе намного более заметную роль, хотя юань постепенно усиливает свои позиции. <a id="export-role"></a>
