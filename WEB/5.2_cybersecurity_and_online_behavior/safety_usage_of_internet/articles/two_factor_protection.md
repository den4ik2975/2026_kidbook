...
![Иллюстрация: дверь с двумя замками и код подтверждения на телефоне](../images/two_factor_protection.jpg)

Иногда одного пароля мало, чтобы хорошо защитить аккаунт. Поэтому существует *двухфакторная защита*. Это дополнительная проверка, которая помогает убедиться, что входишь именно ты.
